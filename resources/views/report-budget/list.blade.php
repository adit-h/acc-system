            ...
            <div class="card">
                <div class="card-header d-flex justify-content-between">
                    <div class="header-title">
                        <h4 class="card-title"> @lang('report.budget_title')</h4>
                    </div>
                </div>
                <div class="card-body justify-content-between">
                    {!! Form::open(['route' => ['report.budget.filter'], 'method' => 'post']) !!}
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="btn-group" role="group" aria-label="Basic example">
                                <a class="btn btn-outline-success" href="{{ route('report.budget.export.excel', ['date_input' => !empty($date) ? $date : '']) }}">
                                    Excel
                                </a>
                                <a class="btn btn-outline-success" href="{{ route('report.budget.export.pdf', ['date_input' => !empty($date) ? $date : '']) }}">
                                    PDF
                                </a>
                                <a class="btn btn-outline-info" href="{{ route('report.budget.export.html', ['date_input' => !empty($date) ? $date : '']) }}">
                                    Print
                                </a>
                            </div>
                        </div>
