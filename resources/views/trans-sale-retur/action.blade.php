<div class="flex align-items-center list-user-action">
    ...
    ?>
    <a class="btn btn-sm btn-icon btn-danger" onclick="return confirm('{{$message}}') ? document.getElementById('transsaleretur-delete-{{$id}}').submit() : false" data-bs-toggle="tooltip" title="Delete Trans" href="#">
        <span class="btn-inner">
    ...
    <form action="{{route('trans.sale.retur.destroy',$id)}}" id="transsaleretur-delete-{{$id}}" method="post">
        @method('delete')
        @csrf()
    </form>
    @endif
