...
<ul class="navbar-nav iq-main-menu"  id="sidebar">
    ...
    <li class="nav-item">
        <a class="nav-link" data-bs-toggle="collapse" href="#budget-menu" role="button" aria-expanded="false" aria-controls="horizontal-menu">
            <i class="icon">
                <svg width="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path opacity="0.4" d="M10.0833 15.958H3.50777C2.67555 15.958 2 16.6217 2 17.4393C2 18.2559 2.67555 18.9207 3.50777 18.9207H10.0833C10.9155 18.9207 11.5911 18.2559 11.5911 17.4393C11.5911 16.6217 10.9155 15.958 10.0833 15.958Z" fill="currentColor"></path>
                    <path opacity="0.4" d="M22.0001 6.37867C22.0001 5.56214 21.3246 4.89844 20.4934 4.89844H13.9179C13.0857 4.89844 12.4102 5.56214 12.4102 6.37867C12.4102 7.1963 13.0857 7.86 13.9179 7.86H20.4934C21.3246 7.86 22.0001 7.1963 22.0001 6.37867Z" fill="currentColor"></path>
        ...
        <ul class="sub-nav collapse" id="budget-menu" data-bs-parent="#sidebar">
            @if (in_array('budget-list', $perms))
            <li class="nav-item ">
                <a class="nav-link {{activeRoute(route('budget.index'))}}" href="{{route('budget.index')}}">
                  <i class="icon">
                        <svg xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                            <g>
                            <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
                  ...
                  <i class="sidenav-mini-icon"> B </i>
                  <span class="item-name"> Budget Transaction</span>
                </a>
            </li>
            @endif
            @if (in_array('report-budget', $perms))
            <li class="nav-item ">
                <a class="nav-link {{activeRoute(route('report.budget.index'))}}" href="{{route('report.budget.index')}}">
                  <i class="icon">
                        <svg xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                            <g>
                            <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
                  ...
                  <i class="sidenav-mini-icon"> BR </i>
                  <span class="item-name"> Budget Report</span>
                </a>
            </li>
            @endif
        </ul>
        ...
        <ul class="sub-nav collapse" id="transaction-menu" data-bs-parent="#sidebar">
            ...
            <li class="nav-item ">
                <a class="nav-link {{activeRoute(route('trans.debt.payment.index'))}}" href="{{route('trans.debt.payment.index')}}">
                  ...
                  <i class="sidenav-mini-icon"> DBP </i>
            ...
            <li class="nav-item ">
                <a class="nav-link {{activeRoute(route('trans.receivable.deposit.index'))}}" href="{{route('trans.receivable.deposit.index')}}">
                  ...
                  <i class="sidenav-mini-icon"> ARD </i>
    ...
    <li class="nav-item">
        <a class="nav-link" data-bs-toggle="collapse" href="#adjustment-journal-menu" role="button" aria-expanded="false" aria-controls="horizontal-menu">
            ...
            <span class="item-name"> @lang('global.adjustment-journal')</span>
            <i class="right-icon">
                <svg xmlns="http://www.w3.org/2000/svg" width="18" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7" />
                </svg>
    ...
    <li class="nav-item">
        <a class="nav-link" data-bs-toggle="collapse" href="#supplies-menu" role="button" aria-expanded="false" aria-controls="horizontal-menu">
            ...
            <span class="item-name"> @lang('global.supplies')</span>
            <i class="right-icon">
                <svg xmlns="http://www.w3.org/2000/svg" width="18" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7" />
                </svg>
    ...
    {{--<li class="nav-item">
        <a class="nav-link {{activeRoute(route('settings.index'))}}" href="{{route('settings.index')}}">
            <i class="icon">
            <svg width="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <li class="nav-item">
        <a class="nav-link {{activeRoute(route('transLimit.index'))}}" href="{{route('transLimit.index')}}">
            <i class="icon">
            <svg width="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path fill-rule="evenodd" clip-rule="evenodd" d="M7.7688 8.71387H16.2312C18.5886 8.71387 20.5 10.5831 20.5 12.8885V17.8254C20.5 20.1308 18.5886 22 16.2312 22H7.7688C5.41136 22 3.5 20.1308 3.5 17.8254V12.8885C3.5 10.5831 5.41136 8.71387 7.7688 8.71387ZM11.9949 17.3295C12.4928 17.3295 12.8891 16.9419 12.8891 16.455V14.2489C12.8891 13.772 12.4928 13.3844 11.9949 13.3844C11.5072 13.3844 11.1109 13.772 11.1109 14.2489V16.455C11.1109 16.9419 11.5072 17.3295 11.9949 17.3295Z" fill="currentColor"></path>
            <path opacity="0.4" d="M17.523 7.39595V8.86667C17.1673 8.7673 16.7913 8.71761 16.4052 8.71761H15.7447V7.39595C15.7447 5.37868 14.0681 3.73903 12.0053 3.73903C9.94257 3.73903 8.26594 5.36874 8.25578 7.37608V8.71761H7.60545C7.20916 8.71761 6.83319 8.7673 6.47754 8.87661V7.39595C6.4877 4.41476 8.95692 2 11.985 2C15.0537 2 17.523 4.41476 17.523 7.39595Z" fill="currentColor"></path>
            ...
            <span class="item-name">Trans Limit</span>
        </a>
    </li>
    <li class="nav-item">
