<x-app-layout :assets="$assets ?? []">
   <div>
      ...
      ?>
      @if(isset($id))
      {!! Form::model($data, ['route' => ['trans.receivable.update', $id], 'method' => 'patch']) !!}
      @else
      {!! Form::open(['route' => ['trans.receivable.store'], 'method' => 'post']) !!}
      @endif
      <div class="row">
            ...
            <div class="card">
               <div class="card-header d-flex justify-content-between">
                  <div class="header-title">
                     <h4 class="card-title">{{$id !== null ? 'Ubah Transaksi Piutang' : 'Transaksi Piutang Baru' }}</h4>
                  </div>
                  <div class="card-action">
                        <a href="{{route('trans.receivable.index')}}" class="btn btn-sm btn-primary" role="button">Back</a>
                  </div>
               </div>
               <div class="card-body">
