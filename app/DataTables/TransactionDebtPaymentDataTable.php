...
class TransactionDebtPaymentDataTable extends DataTable
{
    /**
    ...
    public function dataTable($query)
    {
        return datatables()
            ...
            ->addColumn('action', 'trans-debt-payment.action')
            ->rawColumns(['action']);
    }
    ...
    {
        return 'TransactionDebtPayment_' . date('YmdHis');
    }
}
