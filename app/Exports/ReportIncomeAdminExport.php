...
class ReportIncomeAdminExport implements FromView, WithColumnWidths, WithStyles, WithColumnFormatting
{
    //use Exportable;
    ...
    */
    ...
    public function view(): View
    {
        ...
        return view('reports.export-incomeState-adm', compact('in_data1', 'in_data2', 'out_data1', 'out_data2', 'filter', 'filter_prev',));
    }
